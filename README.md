...
•	Adaptive Model Fallback: Secara otomatis berpindah ke model cadangan (gemini-1.5-flash) jika terkena rate limit (Error 429), dengan tetap mempertahankan riwayat obrolan.
